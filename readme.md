...
- [6. Fases de documentación en un proyecto de software](#)

    - [6.1 Fase de preámbulo](docs/fases/preámbulo.md)

    - [6.2 Fase de exploración](docs/fases/exploración.md)

    - [6.3 Fase de análisis de requerimientos](docs/fases/análisis.md)
    ...
    - [6.6 Fase de entrega](docs/fases/entrega.md)